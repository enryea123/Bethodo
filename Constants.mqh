...
const int MIN_CHANNEL_HEIGHT_ATR = 2;
const int MAX_CHANNEL_HEIGHT_ATR = 6;
const double CHANNEL_BALANCE_RATIO = 0.6;
const double CHANNEL_PARALLEL_SLOPE_THREHSOLD = 0.06;
const int CHANNEL_LINE_WIDTH = 5;
const color CHANNEL_COLOR = clrYellow;

const int CHANNEL_MIN_OPPOSITE_CONTACT_POINT = 6;
const int CHANNEL_PRICE_GAP_CANDLES = 16;
const int CHANNEL_PRICE_GAP_PIPS = 20;
...
const int EXTREMES_MAX_CANDLES = 110;

const int EXTREMES_MIN_DISTANCE = 2;
const int LEVELS_MIN_DISTANCE = 1;
...
const double BREAKEVEN_PERCENTAGE = 1;

const int ATR_AVERAGE_CANDLES = 240;

const int ORDER_SETUP_BUFFER_PIPS = 3;
const int LEVEL_SETUP_BUFFER_PIPS = 5;
...
const int TRENDLINE_MIN_EXTREMES_DISTANCE = 5;
const int TRENDLINE_BEAMS = 3;
const int TRENDLINE_BEAMS_HALF_THICKNESS_PIPS = 2;
...
const double TRENDLINE_BALANCE_RATIO_THRESHOLD = 0.7;
...
void InitializeMaps() {
    ...
    PERCENT_RISK_ACCOUNT_EXCEPTIONS.put(2100188824, 0.1);

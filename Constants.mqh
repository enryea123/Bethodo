...
const int MARKET_ORDER_CLOSE_HOUR = 15;
...
const int MIN_CHANNEL_HEIGHT = 25;
const int MAX_CHANNEL_HEIGHT = 80;
const double CHANNEL_BALANCE_RATIO = 0.65;
const double CHANNEL_PARALLEL_SLOPE_THREHSOLD = 0.07;
...
const int CHART_DEFAULT_ZOOM = 2;
const string LAST_DRAWING_TIME_PREFIX = "LastDrawingTime";

const int TRENDLINE_MIN_CANDLES_LENGTH = 24;
const int TRENDLINE_MIN_EXTREMES_DISTANCE = 6;
...
const double TRENDLINE_MIN_SLOPE_VOLATILITY = 0.0032;
...
void InitializeMaps() {
    ...
    STOPLOSS_SIZE_PIPS.put("AUDUSD", 15);
    STOPLOSS_SIZE_PIPS.put("EURUSD", 14);
    STOPLOSS_SIZE_PIPS.put("GBPAUD", 30);
    STOPLOSS_SIZE_PIPS.put("GBPUSD", 18);
    STOPLOSS_SIZE_PIPS.put("NZDCHF", 12);
    STOPLOSS_SIZE_PIPS.put("NZDUSD", 13);
    STOPLOSS_SIZE_PIPS.lock();

    BREAKEVEN_PERCENTAGE.put("AUDUSD", 1.0);
    BREAKEVEN_PERCENTAGE.put("EURUSD", 1.0);
    BREAKEVEN_PERCENTAGE.put("GBPAUD", 1.0);
    BREAKEVEN_PERCENTAGE.put("GBPUSD", 1.0);
    BREAKEVEN_PERCENTAGE.put("NZDCHF", 1.0);
    BREAKEVEN_PERCENTAGE.put("NZDUSD", 1.0);
